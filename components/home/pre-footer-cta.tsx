...
/**
 * Pre-footer — two adjacent sections with an abrupt polarity flip between
 * them (no gradient transition per DESIGN.md). The dark band on top holds
 * the two hover-image cards (What We Build + Start a Conversation). The
 * light band below holds the centred "Let's talk about what you're
 * building." call with the burnt-orange Book a Call CTA — accent #1.
 */
...
export function PreFooterCta() {
  return (
    <>
      ...
      <section className="am-band-light" style={{ padding: "120px 0" }}>
        <div className="am-container">
          <FadeUp className="mx-auto max-w-[720px] text-center">
            <p className="am-label-caps" style={{ color: "var(--argana-burnt)" }}>
              Get in touch
            </p>
            <h2
              className="am-headline-md mt-6"
              style={{ color: "var(--argana-on-surface)" }}
            >
              Let&apos;s talk about what you&apos;re building.
            </h2>
            <p
              className="am-body-lg mx-auto mt-6 max-w-xl"
              style={{ color: "var(--argana-on-surface-muted)" }}
            >
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              ...
              <Link href="/contact" className="am-cta-ghost-light">
                Send a message
